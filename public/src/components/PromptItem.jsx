...
function PromptItem(props) {
  ...
  return (
    <Container>
        <div className="userdetails text-white ">
        ...
        <div className='centerdiv'>
            <p className='fs-4 text-app-primary'>Create powerful youtube scripts in seconds</p>
            <div className="verticalspacingsmall"></div>
            <p className='text-white fs-6'>Makeup tutorial, how to get rich using youtube and outsourcing script work to freelancers text max is set to 250 characters </p>
        </div>
